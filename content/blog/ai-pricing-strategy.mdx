...
The important pricing question is not only what the AI can do. It is which existing budget already pays for that outcome.

If the product replaces or expands work that a team performs today, price and sell it against that work. Customers understand headcount, outsourced services, and operational cost. They do not need another abstract AI category in the budget.
