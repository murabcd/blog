...
## Authority Follows Action

Software used to earn authority by being the place where data lived. Agents shift that authority toward the place where decisions are made and work gets done.

That does not make the underlying system irrelevant, but it changes what makes the system defensible. Data storage becomes infrastructure. Execution depth, governance, and control over the workflow become the product.
