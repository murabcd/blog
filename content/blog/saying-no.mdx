...
A strategy becomes real when it costs you an opportunity that looked reasonable. Until then, saying no is only a principle in a document.

The point is not to reject more work. It is to protect enough capacity for the few things the product must do exceptionally well. Focus always disappoints someone in the short term. That is the price of making the choice visible.
