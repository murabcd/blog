...
The most valuable asset in enterprise software is not the current feature set. It is the ability to keep changing the product without negotiating with every decision made for one customer years ago.

Sometimes present revenue is worth the constraint. But that trade should be explicit. A custom feature is not free money; it is future flexibility sold in advance.
