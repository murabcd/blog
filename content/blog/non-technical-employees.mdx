...
## Builders, Not Ticket Writers

The useful distinction is no longer technical versus non-technical. It is between people who can move a problem forward themselves and people who can only describe work for somebody else to do.

AI gives more roles access to code, data, and prototypes, but access is not the outcome. The outcome is a shorter distance between noticing a problem and testing a solution. Product teams should be organized around that ownership, not around who was historically allowed to build.
