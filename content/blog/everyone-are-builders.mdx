...
The important change is not that more people can produce software. It is that testing an idea no longer requires a long handoff before anyone can learn whether it works.

When prototypes are cheap, experimentation can become part of normal work. The advantage comes from using that speed to learn, not from producing more things that nobody needed.
