...
## Build for the Next Customer

Your own habits and the feedback from power users are useful, but both come from people who already crossed the hardest part of the product. They know the language, tolerate the complexity, and understand where the value is hidden.

Growth depends on the people who have not crossed that gap. Build for the customer who still needs the product to explain itself, not only for the people who already learned how to work around it.
