...
## Capture Value After You Create It

A pricing model works best when revenue grows because the customer is getting more value, not because the product found another point of friction to tax.

Charge after the value becomes visible and use a metric that expands with customer success. When the choice is unclear, leave more value with the customer. You can capture more later, but only if the customer first has a reason to stay.
