...
The bottleneck is no longer producing code. It is deciding what the system should do, expressing that intent precisely, and defining how anyone can prove it is correct. AI makes implementation cheaper, but it also makes vague thinking more expensive because ambiguity can now turn into software immediately.
