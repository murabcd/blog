...
## Respect the Roadblocks

The path to AGI is not a smooth curve. Today's models can reason through difficult problems, but they still struggle to learn continuously and act reliably in changing environments.

Those limits do not make the progress less real. They make the remaining work more concrete. A sober view should hold both ideas at once: the capability is remarkable, and the roadblocks still matter.
