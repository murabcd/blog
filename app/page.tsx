...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4">
        {`I’m a Chief Product Officer at Flomni, where I lead the product and engineering teams. My job is to help build useful tools that make life easier for our clients — mostly non-technical teams in B2B SaaS companies.`}
      </p>
      <p className="mb-4">
