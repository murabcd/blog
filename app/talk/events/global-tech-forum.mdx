...
Our talk focused on how Flomni's solutions addressed the challenges faced by a major airline like Ural Airlines, which handles millions of passengers yearly. We highlighted key aspects of the project:

- **The Need:** Moving away from costly and sometimes inconvenient phone support towards more efficient digital channels.
- **Our Approach:** A phased implementation of Flomni's chatbot platform, starting with basic automation and evolving to include AI and deep integrations with Ural Airlines' systems.
- **The Outcome:** We successfully automated **63%** of customer inquiries, significantly reducing service costs (**-25%**).
